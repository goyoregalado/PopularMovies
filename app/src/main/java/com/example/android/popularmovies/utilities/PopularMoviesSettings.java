...
/**
 * Created by goyo on 5/2/17.
 * This class is used to store the settings of the Popular Movies app.
 * Basically it stores the different types of sorting criteria that the
 * user can select.
 */
